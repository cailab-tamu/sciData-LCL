...
axis(side = 3,at = atV, labels = c("GM12878-G1", "GM12878-S", "GM12878-G2M", "GM18502-G1", "GM18502-S", "GM18502-G2M"), font = 2, cex.axis=1)
atL <- c(4633,1113,1299,2525,1367,1297)
axis(side = 1, labels = atL, at = atV, tick = 0, line = 0)
mtext("HIGHLY EXPRESSED GENES",side = 3, line = 1.5, cex = 0.8, font = 2)
